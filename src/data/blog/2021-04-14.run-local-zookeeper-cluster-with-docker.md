...
tags:
  - docker
  - zookeeper
description: "学大数据绑不开 ZooKeeper，但安装配置让人头疼？Docker Compose 一键搞定！本文提供单机版和集群版两套方案：单机一行命令 `docker run`；集群三节点配置 ZOO_MY_ID + ZOO_SERVERS，利用 Compose 网络互通特性组成集群。还解决了 Curator 连接集群报 NPE 的坑——需要配置 hosts 通过 hostname 连接。"
---

![文章配图](https://cdn.xkcoding.com/blog/run-local-zookeeper-cluster-with-docker/%E4%BD%BF%E7%94%A8%20docker%20%E5%BF%AB%E9%80%9F%E5%90%AF%E5%8A%A8%E6%9C%AC%E5%9C%B0%20zookeeper%20%E9%9B%86%E7%BE%A4.jpg?x-oss-process=style/tag_compress)
