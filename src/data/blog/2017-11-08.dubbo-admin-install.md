...
7. 配置、调优结束，我们就可以运行 `tomcat/bin/start.sh` 或者 `tomcat/bin/start.bat`，启动 `Tomcat` 查看效果了，因为现在只是搭建了 `dubbo-admin` 还没有 `dubbo` 服务，因此我们现在只浏览首页和一些系统页面。
   - 浏览器输入 `http://localhost:7777` 弹出验证信息。
     ![登录信息](https://cdn.xkcoding.com/2017-11-08-15101329196775.jpg)
   - `dubbo-admin` 首页
     ![首页](https://cdn.xkcoding.com/2017-11-08-15101329460942.jpg)
   - 系统状态
     ![系统状态](https://cdn.xkcoding.com/2017-11-08-15101329647345.jpg)
   - 系统日志
     ![系统日志](https://cdn.xkcoding.com/2017-11-08-15101329831583.jpg)
   - 系统环境
     ![系统环境](https://cdn.xkcoding.com/2017-11-08-15101329768536.jpg)
