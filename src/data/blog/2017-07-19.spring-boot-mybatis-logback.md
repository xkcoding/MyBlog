...
author: xkcoding
pubDatetime: 2017-07-19T03:44:55.000Z
slug: spring-boot-mybatis-logback
featured: false
draft: false
tags:
  - spring-boot
  - mybatis
description: "Spring Boot 整合 MyBatis 后，SQL 语句死活打印不出来？关键在于 logback-spring.xml 里要把 Mapper 接口的包路径配成 DEBUG 级别。本文提供完整的 logback 配置模板，包括控制台输出、按日期滚动的文件日志、独立的错误日志。另外安利 Lombok 的 @Slf4j 注解，告别冗余的 Logger 声明。"
---
...
7. 在 idea 里安装 `lombok` 的相应插件
   ![lombok插件](https://cdn.xkcoding.com/2017-07-19-15004348921948.jpg?x-oss-process=style/tag_compress)
