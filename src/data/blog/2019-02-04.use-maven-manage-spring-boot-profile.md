...
author: xkcoding
pubDatetime: 2019-02-04T01:47:35.000Z
slug: use-maven-manage-spring-boot-profile
featured: false
draft: false
tags:
  - spring-boot
  - java
description: "每次打包都要手动改 spring.profiles.active？太容易出错了！本文介绍 Maven Profile + @xx@ 变量替换的优雅方案：pom.xml 定义 dev/test/prod 三套环境，application.yml 用 @profileActive@ 动态获取，mvn package -P prod 一键打包。还提供了 shell 脚本和 IDEA 可视化操作两种构建方式。"
---
...
<img src="https://cdn.xkcoding.com/blog/use-maven-manage-spring-boot-profile/image-maven-package.png?x-oss-process=style/tag_compress" width="30%">
