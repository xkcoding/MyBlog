...
tags:
  - devops
description: "GitLab 搭好了，下一步就是 Jenkins 持续集成。本文记录完整的 Jenkins 部署实战：JDK 路径配置、阿里云 Maven 镜像加速、个性化邮件模板（含完整 HTML 代码）。还推荐了 Material 风格主题美化方案，以及 11 个必装插件：Gitlab Hook、FireLine 代码规约检查、钉钉通知等。"
---
