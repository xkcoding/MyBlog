...
author: xkcoding
pubDatetime: 2019-08-14T09:56:14.000Z
slug: design-pattern-prototype
featured: false
draft: false
tags:
  - 设计模式
description: "clone() 方法你真的会用吗？浅克隆的坑你踩过没？引用对象地址相同，改一个全变了！本文用「印钞机打印纸币」的场景，对比浅克隆 vs 深克隆的实现差异。深克隆需要实现 Serializable 接口，通过序列化/反序列化实现真正的对象复制。附 BeanUtils、JSON.parseObject 等常见应用。"
---
...
<img src="https://cdn.xkcoding.com/blog/2019-08-19-prototype-shallowclone-uml.png?x-oss-process=style/tag_compress" width="50%" alt="原型模式-浅克隆UML图例"/>
...
<img src="https://cdn.xkcoding.com/blog/2019-08-19-prototype-deepclone-uml.png?x-oss-process=style/tag_compress" width="50%" alt="原型模式-深克隆UML图例"/>
