...
author: xkcoding
pubDatetime: 2018-01-03T03:12:37.000Z
slug: devops-gitlab
featured: false
draft: false
tags:
  - devops
description: "搭建企业私有 Git 仓库，GitLab 是首选。本文涵盖 CentOS 下的完整部署流程：从依赖安装、镜像源配置、QQ 邮箱 SMTP 设置，到中文汉化包的正确使用姿势。还有两个必踩的坑：reconfigure 卡住和端口占用，以及配置 push 时邮件通知 diff 信息的完整方案。"
---
...
5. 重新启动查看效果：`gitlab-ctl start`
   ...
   ![个人首页](https://cdn.xkcoding.com/2018-01-03-15149489321563.jpg?x-oss-process=style/tag_compress)

   ![管理员区域](https://cdn.xkcoding.com/2018-01-03-15149489565891.jpg?x-oss-process=style/tag_compress)
...
4. User Settings --> Notifications 里 email保证正确，选择 level 为第一个，并勾选接收通知如下图
   ...
   ![6801515572021_.pic_hd](https://cdn.xkcoding.com/2018-01-10-6801515572021_.pic_hd.jpg?x-oss-process=style/tag_compress)

5. 创建一个项目

6. Settings --> Integrations --> email on push，具体如下图

   ![6831515572084_.pic_hd](https://cdn.xkcoding.com/2018-01-10-6831515572084_.pic_hd.jpg?x-oss-process=style/tag_compress)
