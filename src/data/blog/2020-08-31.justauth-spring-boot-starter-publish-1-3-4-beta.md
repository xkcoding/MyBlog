...
tags:
  - justauth
  - 开源
description: "JustAuth 新版来袭！1.3.4.beta 两大新特性：① 自定义 HTTP 代理，轻松测试 Google、Facebook 等国外登录；② 自定义 scopes 参数，获取更多用户权限。配置示例一看就懂，附完整 YAML 配置模板。升级 hutool-core 5.4.0 修复 JSONUtil 报错问题。"
---
