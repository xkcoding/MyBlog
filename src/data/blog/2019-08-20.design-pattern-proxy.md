...
tags:
  - 设计模式
description: "Spring AOP 底层到底用的啥？JDK 动态代理 vs CGLIB 动态代理，区别在哪？本文用「售票员卖票」场景讲解：静态代理只能代理特定类，动态代理可代理任意对象。附 JDK Proxy 源码深度剖析（从 newProxyInstance 到 ProxyClassFactory），以及 Spring 的代理选择原则。"
---
...
<img src="https://cdn.xkcoding.com/blog/2019-08-21-proxy-staticproxy-uml.png?x-oss-process=style/tag_compress" width="50%" alt="代理模式-静态代理"/>
...
<img src="https://cdn.xkcoding.com/blog/2019-08-21-proxy-dynamicproxy-jdk-uml.png?x-oss-process=style/tag_compress" alt="代理模式-动态代理-JDK动态代理" />
...
<img src="https://cdn.xkcoding.com/blog/2019-08-21-proxy-dynamicproxy-cglib-uml.png?x-oss-process=style/tag_compress" alt="代理模式-动态代理-CGLIB动态代理" />
...
<img src="https://cdn.xkcoding.com/blog/2019-08-22-095324.png?x-oss-process=style/tag_compress"/>
...
![image-20190824114026176](https://cdn.xkcoding.com/blog/2019-08-24-034026.png?x-oss-process=style/tag_compress)
