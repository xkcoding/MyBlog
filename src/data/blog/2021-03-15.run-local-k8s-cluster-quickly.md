...
author: xkcoding
pubDatetime: 2021-03-15T09:44:47.000Z
slug: run-local-k8s-cluster-quickly
featured: true
draft: false
tags:
  - kubernetes
  - docker
description: "学 K8S 不想只看文档？想在本地搭集群练手却被网络和资源劝退？k3d 了解一下——基于 Docker 运行 k3s，一行命令创建「1主2从」集群，启动快、资源省、还能模拟多节点调度。本文对比 minikube/microk8s/kind/k3d 四种方案，手把手教你用 k3d 搭建本地 K8S 环境，从创建集群到部署 nginx 验证 Ingress，10 分钟搞定。附 kubecm 多集群切换技巧。"
---

![文章配图](https://cdn.xkcoding.com/blog/run-local-k8s-cluster-quickly/%E5%A6%82%E4%BD%95%E5%9C%A8%E6%9C%AC%E5%9C%B0%E5%BF%AB%E9%80%9F%E5%90%AF%E5%8A%A8%E4%B8%80%E4%B8%AA%20K8S%20%E9%9B%86%E7%BE%A4.jpg?x-oss-process=style/tag_compress)
...
![k3d-network](https://cdn.xkcoding.com/blog/run-local-k8s-cluster-quickly/k3d-network.png?x-oss-process=style/tag_compress)
