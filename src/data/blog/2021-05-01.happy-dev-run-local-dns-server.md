...
tags:
  - docker
  - dns
description: "本地开发服务太多，ip:port 记不住？用域名替代！方案一：SwitchHosts 修改 hosts 文件，简单但不支持泛域名；方案二：dnsmasq 容器化部署，一行配置支持 *.dev.io 泛域名解析；方案三：go-dnsmasq 解决内存泄漏问题，镜像仅 2.7M。附 Docker Compose 配置 + M1 芯片本地编译教程。"
---
...
这里推荐一款工具，[SwitchHosts](https://swh.app/zh/)（_记忆中，之前的版本叫做 `SwitchHosts!`_），页面简洁，操作一目了然。

配置 Hosts 文件，只需要将域名的地址跟 IP 做映射即可。
![SwitchHosts](https://cdn.xkcoding.com/2021/09/03/16305752555388.jpg)
...
![dnsmasq管理界面](https://cdn.xkcoding.com/2021/09/03/16305767071171.jpg)
...
![DNS配置](https://cdn.xkcoding.com/2021/09/03/16305773370388.jpg)
...
2. 修改 Dockfile 内容，将 upx 注释一下，代码如下：
