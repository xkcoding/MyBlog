...
tags:
  ...
  - dubbo
  - linux
description: "学 Dubbo 之前先把注册中心搭好。本文手把手教你在 3 台 Linux 虚拟机上搭建 Zookeeper 集群：从下载解压到配置 zoo.cfg，从创建 myid 文件到配置环境变量，每一步都有详细命令。最后验证集群状态，一个 leader 两个 follower，高可用注册中心就绑了。Dubbo 入门的前置必修课。"
---
