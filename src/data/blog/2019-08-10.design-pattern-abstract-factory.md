...
tags:
  - 设计模式
description: "简单工厂生产单一产品，工厂方法还是单一产品，抽象工厂才是「产品族」！本文用科技公司卖手机+笔记本+耳机的场景讲解：小米、华为、苹果三家公司，每家都有自己的产品线。TechFactory 抽象工厂定义 sellPhone/sellLaptop/sellEarPhone 三个方法，子类各自实现。附 Spring AbstractBeanFactory 源码分析。"
---
...
![抽象工厂模式UML图](https://cdn.xkcoding.com/blog/2019-08-09-abstractfactory-uml.png?x-oss-process=style/tag_compress)
