...
![image-20190615165843639](https://static.xkcoding.com/blog/2019-07-06-095756.png)
...
3. 应用管理 -> 添加网站应用，等待审核通过即可
   ...
   ![image-20190617144655429](https://static.xkcoding.com/blog/2019-07-06-095903.png)
...
2. 点击 `New OAuth App` 按钮创建应用
   ...
   ![image-20190617145839851](https://static.xkcoding.com/blog/2019-07-06-095917.png)
...
![image-20190617153552218](https://static.xkcoding.com/blog/2019-07-06-095936.png)
...
2. 前往 https://console.developers.google.com/apis/credentials ，在第一步创建的项目下，添加应用
   ...
   ![image-20190617151119584](https://static.xkcoding.com/blog/2019-07-06-100015.png)

   ![image-20190617150903039](https://static.xkcoding.com/blog/2019-07-06-100027.png)
...
2. 在注册应用的时候就需要填写回调地址，当然后期也可以重新修改
   ...
   ![image-20190617152529449](https://static.xkcoding.com/blog/2019-07-06-100042.png)

3. client id 在这里

   ![image-20190617152805581](https://static.xkcoding.com/blog/2019-07-06-100056.png)

4. client secret 需要自己在这里生成

   ![image-20190617152711938](https://static.xkcoding.com/blog/2019-07-06-100106.png)
...
3. 填写基本信息之后，进入应用信息页面填写 `回调地址`
   ...
   ![image-20190617151502414](https://static.xkcoding.com/blog/2019-07-06-100126.png)

4. 应用审核通过之后，可以在应用信息页面的 `应用详情` 查看到 AppKey 和 AppSecret，吐槽下，小米应用的审核速度特别慢，需要耐心等待。。。。

   ![image-20190617151624603](https://static.xkcoding.com/blog/2019-07-06-100139.png)
