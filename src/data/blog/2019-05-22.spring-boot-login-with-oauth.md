...
author: xkcoding
pubDatetime: 2019-05-22T08:21:43.000Z
slug: spring-boot-login-with-oauth
featured: false
draft: false
tags:
  - spring-boot
  - justauth
  - 开源
description: "QQ、微信、GitHub、Google、微软……7 种第三方登录一次搞定！使用 JustAuth + justauth-spring-boot-starter 快速集成，yml 配置 + 一个 Controller 就能跑。本文还手把手教你搭建 frp 内网穿透环境、各平台应用申请流程，从零到能跑的完整指南。"
---
...
![image-20190615165843639](https://cdn.xkcoding.com/blog/2019-07-06-095756.png?x-oss-process=style/tag_compress)
...
3. 应用管理 -> 添加网站应用，等待审核通过即可
   ...
   ![image-20190617144655429](https://cdn.xkcoding.com/blog/2019-07-06-095903.png?x-oss-process=style/tag_compress)
...
2. 点击 `New OAuth App` 按钮创建应用
   ...
   ![image-20190617145839851](https://cdn.xkcoding.com/blog/2019-07-06-095917.png?x-oss-process=style/tag_compress)

#### 1.5.3 微信开放平台申请

这里微信开放平台需要用企业的，个人没有资质，所以我在某宝租了一个月的资质，需要的可以 [戳我租赁](https://item.taobao.com/item.htm?_u=glbphk50b73&id=565260113566)
...
![image-20190617153552218](https://cdn.xkcoding.com/blog/2019-07-06-095936.png?x-oss-process=style/tag_compress)
...
2. 前往 https://console.developers.google.com/apis/credentials ，在第一步创建的项目下，添加应用
   ...
   ![image-20190617151119584](https://cdn.xkcoding.com/blog/2019-07-06-100015.png?x-oss-process=style/tag_compress)

   ![image-20190617150903039](https://cdn.xkcoding.com/blog/2019-07-06-100027.png?x-oss-process=style/tag_compress)
...
2. 在注册应用的时候就需要填写回调地址，当然后期也可以重新修改
   ...
   ![image-20190617152529449](https://cdn.xkcoding.com/blog/2019-07-06-100042.png?x-oss-process=style/tag_compress)

3. client id 在这里

   ![image-20190617152805581](https://cdn.xkcoding.com/blog/2019-07-06-100056.png?x-oss-process=style/tag_compress)

4. client secret 需要自己在这里生成

   ![image-20190617152711938](https://cdn.xkcoding.com/blog/2019-07-06-100106.png?x-oss-process=style/tag_compress)
...
3. 填写基本信息之后，进入应用信息页面填写 `回调地址`
   ...
   ![image-20190617151502414](https://cdn.xkcoding.com/blog/2019-07-06-100126.png?x-oss-process=style/tag_compress)

4. 应用审核通过之后，可以在应用信息页面的 `应用详情` 查看到 AppKey 和 AppSecret，吐槽下，小米应用的审核速度特别慢，需要耐心等待。。。。

   ![image-20190617151624603](https://cdn.xkcoding.com/blog/2019-07-06-100139.png?x-oss-process=style/tag_compress)
...
![image-20190809161032422](https://cdn.xkcoding.com/blog/2019-08-09-081033.png?x-oss-process=style/tag_compress)
