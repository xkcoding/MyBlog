...
author: xkcoding
pubDatetime: 2019-03-12T01:51:34.000Z
slug: scaffold-doc
featured: false
draft: false
tags:
  - spring-boot
  - 开源
description: "Spring Boot 项目总是重复造轮子？scaffold 开源脚手架帮你搞定！10 个模块覆盖常见需求：launcher 多环境启动器、common 统一返回格式、log 操作日志注解、swagger 自动装配、web 全局异常处理、code 验证码、notification 钉钉/邮件/短信通知、codegen 代码生成器。开箱即用，让你专注业务逻辑。"
---
...
<img src="https://cdn.xkcoding.com/blog/scaffold-doc/image-scaffold-xmind-1.0.8.png?x-oss-process=style/tag_compress"/>
...
5. idea开发场景下设置参考下图
   ...
   <img src="https://cdn.xkcoding.com/blog/scaffold-doc/image-edit_config.png?x-oss-process=style/tag_compress" width="30%" />

   <img src="https://cdn.xkcoding.com/blog/scaffold-doc/image-set_profiles.png?x-oss-process=style/tag_compress" width="90%" />
...
<img src="https://cdn.xkcoding.com/blog/scaffold-doc/image-swagger.png?x-oss-process=style/tag_compress" />
          ...
          <div style="flex: 1;text-align: center;">
            <div>
              <img
                width="180px"
                height="180px"
                src="https://cdn.xkcoding.com/blog/resources/wechat-reward-image.png?x-oss-process=style/tag_compress"
              />
            </div>
            <div>微信打赏</div>
          </div>
          <div style="flex: 1;text-align: center;">
            <div>
              <img
                width="180px"
                height="180px"
                src="https://cdn.xkcoding.com/blog/resources/alipay-reward-image.png?x-oss-process=style/tag_compress"
              />
            </div>
            <div>支付宝打赏</div>
          </div>
...
<img src="https://cdn.xkcoding.com/blog/scaffold-doc/image-scaffold-notification-dingtalk.png?x-oss-process=style/tag_compress" width="60%"/>

**简单邮件**

<img src="https://cdn.xkcoding.com/blog/scaffold-doc/image-scaffold-notification-email-simple.png?x-oss-process=style/tag_compress"/>

**复杂邮件**

<img src="https://cdn.xkcoding.com/blog/scaffold-doc/image-scaffold-notification-email-mime.png?x-oss-process=style/tag_compress"/>

**短信**

<img src="https://cdn.xkcoding.com/blog/scaffold-doc/image-scaffold-notification-sms.png?x-oss-process=style/tag_compress" width=40%/>
...
| scaffold.codegen.table-prefix      | tb\_         | 表前缀(类名不会包含表前缀) |
...
<img src="https://cdn.xkcoding.com/blog/scaffold-doc/image-scaffold-codegen.png?x-oss-process=style/tag_compress"/>
