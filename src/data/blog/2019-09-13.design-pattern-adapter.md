...
author: xkcoding
pubDatetime: 2019-09-13T08:18:23.000Z
slug: design-pattern-adapter
featured: false
draft: false
tags:
  - 设计模式
description: "电脑 USB 接口和手机 Type-C 不兼容？买个转接头啊！适配器模式就是代码世界的「转接头」。本文用 USB 转 Type-C 的场景讲解：老接口不改动，新增适配器类做转换。Spring MVC 的 HandlerAdapter、Spring AOP 的 AdvisorAdapter 都是典型应用。"
---
...
<img src="https://cdn.xkcoding.com/blog/2019-09-29-design-pattern-adapter-uml.png?x-oss-process=style/tag_compress" alt="design-pattern-adapter-uml" style="zoom:50%;" />
