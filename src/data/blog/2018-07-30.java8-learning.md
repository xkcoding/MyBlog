...
title: "Java8 学习整理"
author: xkcoding
pubDatetime: 2018-07-30T02:39:07.000Z
slug: java8-learning
featured: false
draft: false
tags:
  - java
description: "公司内部 Java 8 分享的完整文档！从 JDK 5 到 JDK 8 的发展历程梳理，重点讲解 Lambda 表达式、函数式接口、Stream API、Optional 类、新日期时间 API 等核心特性。每个特性都附带 Demo 代码，拿来即用。还在用 for 循环？是时候拥抱函数式编程了。"
---
