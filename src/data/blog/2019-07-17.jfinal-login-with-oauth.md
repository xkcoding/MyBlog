...
author: xkcoding
pubDatetime: 2019-07-17T10:30:46.000Z
slug: jfinal-login-with-oauth
featured: false
draft: false
tags:
  - java
  - justauth
  - 开源
description: "不用 Spring Boot 也能快速接入第三方登录！本文演示 JFinal 框架如何通过 JustAuth 集成 QQ、GitHub、小米登录。踩坑记录：JFinal 路由不支持 /{type}/callback 格式，回调地址要改成 /callback/{type}。附完整配置文件和 Controller 代码。"
---
