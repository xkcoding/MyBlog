...
author: xkcoding
pubDatetime: 2018-01-12T09:11:18.000Z
slug: elasticsearch-note
featured: false
draft: false
tags:
  - elasticsearch
  - java
description: "从零到一的 ElasticSearch 完整学习笔记！覆盖单机安装、分布式集群配置、head 插件和 ik 中文分词插件安装。详解索引、类型、文档、分片等核心概念，附带大量 RESTful API 示例：条件查询、聚合查询、复合查询。最后用 Spring Boot 整合 ES，实现增删改查和复杂搜索功能。"
---
...
6. 测试，打开 PostMan 测试 http://localhost:9200 ，查看返回的 JSON 信息
   ...
   ![PostMan测试单机部署结果](https://cdn.xkcoding.com/2018-01-12-15157443065618.jpg?x-oss-process=style/tag_compress)
...
5. 启动 head 插件，打开浏览器，访问 http://localhost:9100，查看分布式节点的运行状态
   ...
   ![分布式 ES 的集群状态](https://cdn.xkcoding.com/2018-01-12-15157518741687.jpg?x-oss-process=style/tag_compress)
...
6. 打开浏览器，访问 http://localhost:9100/ ，查看 head 插件运行效果
   ...
   ![运行 head 插件，查看单机 ES 状态](https://cdn.xkcoding.com/2018-01-12-15157472517495.jpg?x-oss-process=style/tag_compress)
...
![创建索引](https://cdn.xkcoding.com/2018-01-17-15161702463041.jpg?x-oss-process=style/tag_compress)
...
![指定 id 插入](https://cdn.xkcoding.com/2018-01-17-15161719204773.jpg?x-oss-process=style/tag_compress)
...
![不指定 id 插入](https://cdn.xkcoding.com/2018-01-17-15161725779321.jpg?x-oss-process=style/tag_compress)

然后前往 head 插件查看是否插入数据

![head 插件中查看添加的文档记录](https://cdn.xkcoding.com/2018-01-17-15161727420397.jpg?x-oss-process=style/tag_compress)
...
注意：修改的时候 URL 必须后面跟\_update，然后要修改的字段必须放在 doc 字段里。
...
![修改文档](https://cdn.xkcoding.com/2018-01-17-15161741012942.jpg?x-oss-process=style/tag_compress)
...
![预先插入的原始数据](https://cdn.xkcoding.com/2018-01-17-15161767712389.jpg?x-oss-process=style/tag_compress)
