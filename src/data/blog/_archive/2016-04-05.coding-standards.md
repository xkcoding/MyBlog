...
![设置工作空间编码为UTF-8](https://cdn.xkcoding.com/blog/resources/coding-standards-1.png)

### 2.2. 设置文件编码为UTF-8

![设置JAVA文件编码为UTF-8](https://cdn.xkcoding.com/blog/resources/coding-standards-2.1.png)
![设置XML文件编码为UTF-8](https://cdn.xkcoding.com/blog/resources/coding-standards-2.2.png)

### 2.3. 方法变量名转化成成员变量名称时，变量名称前加m以示区分

![方法变量名转化成成员变量名称时，变量名称前加m以示区分](https://cdn.xkcoding.com/blog/resources/coding-standards-3.png)
